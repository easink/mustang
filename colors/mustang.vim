...
hi SpellBad	guifg=red     guibg=NONE    gui=none ctermfg=1 ctermbg=none cterm=bold
hi SpellCap	guifg=salmon  guibg=NONE    gui=none ctermfg=1 ctermbg=none cterm=bold
